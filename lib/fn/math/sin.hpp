...
#ifndef LIB_FN_MATH_SIN_HPP_
#define LIB_FN_MATH_SIN_HPP_
...
FN_MATH_UNARY_FUNC_TEMPLATE_SPEC( sin, float,       std::sin(arg0) )
FN_MATH_UNARY_FUNC_TEMPLATE_SPEC( sin, double,      std::sin(arg0) )
FN_MATH_UNARY_FUNC_TEMPLATE_SPEC( sin, long double, std::sin(arg0) )
