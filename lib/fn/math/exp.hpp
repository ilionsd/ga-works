...
#ifndef LIB_FN_MATH_EXP_HPP_
#define LIB_FN_MATH_EXP_HPP_
...
FN_MATH_UNARY_FUNC_TEMPLATE_SPEC( exp, float,       std::exp(arg0) )
FN_MATH_UNARY_FUNC_TEMPLATE_SPEC( exp, double,      std::exp(arg0) )
FN_MATH_UNARY_FUNC_TEMPLATE_SPEC( exp, long double, std::exp(arg0) )
